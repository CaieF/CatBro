import { Animation, math, Tween } from "cc";
import { AnimationTypeEnum, IEnemy, InputTypeEnum, MaterialTypeEnum } from "../../../Common";
...
export class EnemyDeadState extends EnemyState {
    ...
    public enter(): void {
        ...
        this.manager.am.once(Animation.EventType.FINISHED, () => {
            ...
            const materialType: string = 'Material0' + math.randomRangeInt(1, 4);
            DataManager.Instance.applyInput({
                type: InputTypeEnum.MaterialDrop,
                materialType: materialType as MaterialTypeEnum,
                position: { x: this.manager.node.position.x, y: this.manager.node.position.y },
            })
